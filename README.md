...
### 扫描设置
输入照片文件夹路径，调整相似度阈值，一键开始扫描。

![扫描设置](screenshots/2.png)

### 扫描进度
实时显示扫描进度，包括文件扫描、缩略图提取、指纹计算、分组识别四个阶段。

![扫描进度](screenshots/4.png)

### 逐组审核
每组相似照片并排展示，绿色边框 = 保留，红色边框 = 删除。已编辑的照片会标记「已编辑」标签，智能推荐优先保留。

![逐组审核](screenshots/5.png)

### 一键清理
查看智能推荐方案：保留多少张、删除多少张、释放多少空间，确认后一键执行。

![一键清理](screenshots/1.png)

### 清理完成
所有文件安全移入回收站，随时可恢复。

![清理完成](screenshots/3.png)
